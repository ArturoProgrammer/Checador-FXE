namespace Checador_FXE.MdiForms
{
    partial class mdiQuincenaView
    {
        ...
        private void InitializeComponent()
        {
            ...
            panel6 = new Panel();
            btnDefinirRelacionMensual = new FlowControls.flCustomButton();
            btnExpandir = new FlowControls.flCustomButton();
            label1 = new Label();
            ...
            flExtendedTabControl1.Size = new Size(830, 586);
            ...
            pageGeneral.Size = new Size(822, 538);
            ...
            tableLayoutPanel4.Size = new Size(820, 536);
            ...
            txtAutorizador.InputStyle = FlowControls.TextStyle.Normal;
            ...
            txtNombreElaborador.InputStyle = FlowControls.TextStyle.Normal;
            ...
            txtLugarRemitente.InputStyle = FlowControls.TextStyle.Normal;
            ...
            txtAreaRemitente.InputStyle = FlowControls.TextStyle.Normal;
            ...
            headerAsistencias.Size = new Size(814, 45);
            ...
            txtEmpleadoSeleccionado.InputStyle = FlowControls.TextStyle.Normal;
            ...
            // panel5
            // 
            panel5.Controls.Add(flLabelHeader1);
            panel5.Controls.Add(btnSincronizarAjustes);
            panel5.Controls.Add(panel1);
            panel5.Controls.Add(txtMaximoRetrasoMinutosPermitidos);
            panel5.Controls.Add(chckDomingosNoLaborables);
            ...
            btnSincronizarAjustes.Location = new Point(646, 50);
            btnSincronizarAjustes.Name = "btnSincronizarAjustes";
            btnSincronizarAjustes.Size = new Size(131, 50);
            ...
            dgvTurnosHorarios.AllowUserToDeleteRows = true;
            dgvTurnosHorarios.AllowUserToOrderColumns = false;
            dgvTurnosHorarios.AllowUserToResizeColumns = true;
            dgvTurnosHorarios.AllowUserToResizeRows = true;
            dgvTurnosHorarios.AlternatingRowsDefaultCellStyle.BackColor = SystemColors.GradientInactiveCaption;
            dgvTurnosHorarios.AlternatingRowsDefaultCellStyle.ForeColor = Color.FromArgb(64, 64, 64);
            dgvTurnosHorarios.AlternatingRowsDefaultCellStyle.SelectionBackColor = Color.SteelBlue;
            dgvTurnosHorarios.AlternatingRowsDefaultCellStyle.SelectionForeColor = SystemColors.ActiveCaptionText;
            dgvTurnosHorarios.AutoGenerateColumns = true;
            dgvTurnosHorarios.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            dgvTurnosHorarios.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None;
            ...
            dgvTurnosHorarios.CellBorderStyle = DataGridViewCellBorderStyle.Single;
            dgvTurnosHorarios.ClipboardCopyMode = DataGridViewClipboardCopyMode.EnableWithAutoHeaderText;
            dgvTurnosHorarios.ColumnHeadersBorderStyle = DataGridViewHeaderBorderStyle.Single;
            dgvTurnosHorarios.ColumnHeadersDefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            dgvTurnosHorarios.ColumnHeadersDefaultCellStyle.BackColor = Color.SteelBlue;
            dgvTurnosHorarios.ColumnHeadersDefaultCellStyle.Font = new Font("Segoe UI", 10F);
            dgvTurnosHorarios.ColumnHeadersDefaultCellStyle.ForeColor = SystemColors.ButtonFace;
            dgvTurnosHorarios.ColumnHeadersDefaultCellStyle.SelectionBackColor = Color.Orange;
            dgvTurnosHorarios.ColumnHeadersDefaultCellStyle.SelectionForeColor = SystemColors.ControlText;
            dgvTurnosHorarios.ColumnHeadersDefaultCellStyle.WrapMode = DataGridViewTriState.True;
            dgvTurnosHorarios.ColumnHeadersHeight = 23;
            ...
            dgvTurnosHorarios.CurrentCell = null;
            dgvTurnosHorarios.DataMember = "";
            dgvTurnosHorarios.DataSource = null;
            dgvTurnosHorarios.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            dgvTurnosHorarios.DefaultCellStyle.BackColor = Color.White;
            dgvTurnosHorarios.DefaultCellStyle.Font = new Font("Segoe UI", 9F);
            dgvTurnosHorarios.DefaultCellStyle.ForeColor = Color.FromArgb(64, 64, 64);
            dgvTurnosHorarios.DefaultCellStyle.Padding = new Padding(3, 0, 3, 0);
            dgvTurnosHorarios.DefaultCellStyle.SelectionBackColor = Color.Orange;
            dgvTurnosHorarios.DefaultCellStyle.SelectionForeColor = Color.Black;
            dgvTurnosHorarios.DefaultCellStyle.WrapMode = DataGridViewTriState.False;
            dgvTurnosHorarios.Dock = DockStyle.Fill;
            dgvTurnosHorarios.EditMode = DataGridViewEditMode.EditOnKeystrokeOrF2;
            ...
            dgvTurnosHorarios.MouseHoverEffectEnabled = true;
            dgvTurnosHorarios.MultiSelect = false;
            dgvTurnosHorarios.Name = "dgvTurnosHorarios";
            dgvTurnosHorarios.ReadOnly = false;
            dgvTurnosHorarios.RowHeadersVisible = false;
            dgvTurnosHorarios.RowHeadersWidth = 45;
            dgvTurnosHorarios.RowHeadersWidthSizeMode = DataGridViewRowHeadersWidthSizeMode.EnableResizing;
            dgvTurnosHorarios.RowsDefaultCellStyle.SelectionBackColor = Color.SteelBlue;
            ...
            dgvTurnosHorarios.ShowContextMenu = true;
            ...
            txtMaximoRetrasoMinutosPermitidos.Location = new Point(3, 317);
            ...
            chckDomingosNoLaborables.Location = new Point(374, 317);
            ...
            // panel6
            // 
            panel6.Controls.Add(btnDefinirRelacionMensual);
            panel6.Controls.Add(btnExpandir);
            ...
            btnDefinirRelacionMensual.Location = new Point(249, 344);
            btnDefinirRelacionMensual.Margin = new Padding(3, 3, 8, 3);
            btnDefinirRelacionMensual.Name = "btnDefinirRelacionMensual";
            btnDefinirRelacionMensual.Size = new Size(231, 45);
            btnDefinirRelacionMensual.TabIndex = 10;
            ...
            btnExpandir.Location = new Point(7, 344);
            btnExpandir.Margin = new Padding(3, 3, 8, 3);
            btnExpandir.Name = "btnExpandir";
            btnExpandir.Size = new Size(231, 45);
            ...
            flLabelHeader2.Dock = DockStyle.Top;
            ...
            flLabelHeader2.Location = new Point(0, 0);
            ...
            dgvRelacionDeHorarios.AlternatingRowsDefaultCellStyle.SelectionForeColor = SystemColors.ActiveCaptionText;
            ...
            dgvRelacionDeHorarios.ColumnHeadersDefaultCellStyle.SelectionForeColor = SystemColors.ControlText;
            ...
            dgvRelacionDeHorarios.MouseHoverEffectEnabled = true;
            ...
            txtBusqueda.InputStyle = FlowControls.TextStyle.Normal;
            ...
            treePagingResultadosCasting.HeaderFont = new Font("Segoe UI", 9F, FontStyle.Bold);
            treePagingResultadosCasting.HeaderForeColor = SystemColors.ControlText;
            treePagingResultadosCasting.HidePagingIfSinglePage = false;
            ...
            tableLayoutPanel2.Size = new Size(836, 631);
