namespace Checador_FXE
{
    partial class frmCrudEmpleados
    {
        ...
        private void InitializeComponent()
        {
            ...
            dgvAjustesEmpleados.AllowUserToDeleteRows = true;
            dgvAjustesEmpleados.AllowUserToOrderColumns = false;
            dgvAjustesEmpleados.AllowUserToResizeColumns = true;
            dgvAjustesEmpleados.AllowUserToResizeRows = true;
            dgvAjustesEmpleados.AlternatingRowsDefaultCellStyle.BackColor = SystemColors.GradientInactiveCaption;
            dgvAjustesEmpleados.AlternatingRowsDefaultCellStyle.ForeColor = Color.FromArgb(64, 64, 64);
            dgvAjustesEmpleados.AlternatingRowsDefaultCellStyle.SelectionBackColor = Color.SteelBlue;
            dgvAjustesEmpleados.AlternatingRowsDefaultCellStyle.SelectionForeColor = Color.Black;
            dgvAjustesEmpleados.AutoGenerateColumns = true;
            dgvAjustesEmpleados.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            dgvAjustesEmpleados.AutoSizeRowsMode = DataGridViewAutoSizeRowsMode.None;
            ...
            dgvAjustesEmpleados.CellBorderStyle = DataGridViewCellBorderStyle.Single;
            dgvAjustesEmpleados.ClipboardCopyMode = DataGridViewClipboardCopyMode.EnableWithAutoHeaderText;
            dgvAjustesEmpleados.ColumnHeadersBorderStyle = DataGridViewHeaderBorderStyle.Single;
            dgvAjustesEmpleados.ColumnHeadersDefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            dgvAjustesEmpleados.ColumnHeadersDefaultCellStyle.BackColor = Color.SteelBlue;
            dgvAjustesEmpleados.ColumnHeadersDefaultCellStyle.Font = new Font("Segoe UI", 10F);
            dgvAjustesEmpleados.ColumnHeadersDefaultCellStyle.ForeColor = SystemColors.ButtonFace;
            dgvAjustesEmpleados.ColumnHeadersDefaultCellStyle.SelectionBackColor = Color.Orange;
            dgvAjustesEmpleados.ColumnHeadersDefaultCellStyle.SelectionForeColor = Color.Black;
            dgvAjustesEmpleados.ColumnHeadersDefaultCellStyle.WrapMode = DataGridViewTriState.True;
            dgvAjustesEmpleados.ColumnHeadersHeight = 23;
            ...
            dgvAjustesEmpleados.CurrentCell = null;
            dgvAjustesEmpleados.DataMember = "";
            dgvAjustesEmpleados.DataSource = null;
            dgvAjustesEmpleados.DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleLeft;
            dgvAjustesEmpleados.DefaultCellStyle.BackColor = Color.White;
            dgvAjustesEmpleados.DefaultCellStyle.Font = new Font("Segoe UI", 9F);
            dgvAjustesEmpleados.DefaultCellStyle.ForeColor = Color.FromArgb(64, 64, 64);
            dgvAjustesEmpleados.DefaultCellStyle.Padding = new Padding(3, 0, 3, 0);
            dgvAjustesEmpleados.DefaultCellStyle.SelectionBackColor = Color.Orange;
            dgvAjustesEmpleados.DefaultCellStyle.SelectionForeColor = Color.Black;
            dgvAjustesEmpleados.DefaultCellStyle.WrapMode = DataGridViewTriState.False;
            ...
            dgvAjustesEmpleados.RowHeadersWidthSizeMode = DataGridViewRowHeadersWidthSizeMode.EnableResizing;
            dgvAjustesEmpleados.RowsDefaultCellStyle.SelectionBackColor = Color.SteelBlue;
            dgvAjustesEmpleados.RowsDefaultCellStyle.SelectionForeColor = Color.Black;
